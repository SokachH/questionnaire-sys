<template>
  <div class="home">
    ...
    <!--右侧操作栏-->
    <div class="right">
      <el-button type="success" icon="el-icon-upload" style="margin: 5px"
        >发布问卷</el-button
      ><br />
      <el-button type="primary" icon="el-icon-view" style="margin: 5px"
        >预览问卷</el-button
      ><br />
      <el-button type="danger" icon="el-icon-delete" style="margin: 5px"
        >删除问卷</el-button
      >
